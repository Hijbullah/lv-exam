        ...
        <div class="py-8">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="w-full overflow-hidden mt-8">
                    <div v-if="hasBatch">
                        <div v-if="isBatchApproved" class="flex">
                        ...
                        <div v-else class="text-center">
                            <p class="text-xl text-gray-900 font-semibold">You have Requested For Batch <span class="text-indigo-600 font-extrabold border-b-2 border-indigo-700">{{ $page.batch.batch.name }}</span>.</p>
                            <p class="text-xl text-gray-900 font-semibold">Wait for Approval.</p>
                        </div>                
                    </div>
                    <div v-else>
                        <div class="max-w-md mx-auto">
                            <p class="mb-4 text-red-700 text-center text-xl font-semibold">You have no Batch! Go to Batch section and Request for One </p>
                        </div> 
                    </div>
                </div>
            </div>
